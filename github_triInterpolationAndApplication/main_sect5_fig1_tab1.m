%{
The function generates Fig 1 and Table 1 in Section 5
%}

function main_sect5_fig1_tab1()
    check_bdy_deg = 5;
    plot_size = 2^12;
    a = 1; 
    e = a;
    ...
    counter = 1;
    enhancement_status = zeros(rows,5);
    for bid = 1:length(bs)
        b=bs(bid);
        right = b;
        left = -right;
        ...
        for q = qs
            ...
            for did = 1:length(ds)
                ...
                [h_coef_e, delta] = fourier_normalizer_get_coef_cut_off(q,left,s,e,right,cut_off_para);
                ...
                enhancement_status(counter,:) = [a,b-a,d,q,delta];
            ...
            if q == qs(1) && b==2
                file_name_coef_d_impact = ['output/sect5_fig1_b_',  num2str(b), '_q_', num2str(q), '_cut_off' , fig_type];
