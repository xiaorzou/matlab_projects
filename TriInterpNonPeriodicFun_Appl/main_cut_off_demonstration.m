...
function  main_cut_off_demonstration()
    ...
    for q = qs
        ...
        if q == 10
            ...
            file_name_period = ['output/fig_2_', num2str(q), fig_type];
    ...
    fourier_normalizer_test_hf_file = 'output/fig_2.xlsx';
