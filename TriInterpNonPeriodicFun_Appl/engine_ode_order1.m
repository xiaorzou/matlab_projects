...
values in the implemetation.
    ...
    smoothing:  true-> applying cut-off,  false--> no cut-off applied
output:
...
%}
function [x_N, u_N , u_init_N, z_N, z_init_N, pos, myobjopt] = engine_ode_order1(fun, partial_u, y_s, z_s, s, e, p,q, init_method, smoothing)
