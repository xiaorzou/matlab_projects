        ...
        for q = qs
            ...
            for did = 1:length(ds)
                ...
                if isplot && b == 2 
                    ...
                    xlabel = '$x$';
                    ylabel_h_der = ['$h^{(1)}$'];
                    plot_latex(h_der_file_name, x, h_der, title_der, legend_h_der, xlabel, ylabel_h_der, plot_location, 'blue')
                    %plot_latex(file_name, X, Y, title_this, legend_this, xlabel_this, ylabel_this, location, color_code)
            ...
            if q == qs(1) && b==2
                file_name_coef_d_impact = ['output/fig_1_b_',  num2str(b), '_q_', num2str(q), '_cut_off' , fig_type];
